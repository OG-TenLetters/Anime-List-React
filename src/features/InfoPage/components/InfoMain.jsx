...
const InfoMain = ({ showContactModal }) => {
                    ...
                    <img className="template__cover-bg" src={TemplateImg} alt="" />
                      ...
                      <div className="template__details">
                        <div className="template__summary">
                          ...
                          her search for a set of magical objects called the "Dragon
                          Balls." Since the artifacts are said to grant one wish to
                          whoever collects all seven, Bulma hopes to gather them and
                          wish for a perfect boyfriend. Goku happens to be in
                          possession of a dragon ball, but unfortunately for Bulma,
                          he refuses to part ways with it, so she makes him a deal:
                          he can tag along on her journey if he lets her borrow the
                          dragon ball's power. With that, the two set off on the
                          journey of a lifetime. They don't go on the journey alone.
                          On the way, they meet the old Muten-Roshi and wannabe
                          disciple Kuririn, with whom Goku trains to become a
                          stronger martial artist for the upcoming World Martial
                          Arts Tournament. However, it's not all fun and games; the
                          ability to make any wish come true is a powerful one, and
                          there are others who would do much worse than just wishing
                          for a boyfriend. To stop those who would try to abuse the
                        ...
                        <div className="template__extra">
                          <p><b>Japanese:</b> ドラゴンボール </p>
                          <p><b>Synonyms:</b> Dragonball, DB </p>
                          <p><b>Aired:</b> Feb 26, 1986 to Apr 12, 1989 </p>
                          <p><b>Premiered:</b> Winter 1986</p>
                          <p><b>Duration:</b> 24m </p>
                          <p><b>Status:</b> Finished Airing </p>
                          <p><b>MAL Score:</b> 8.02</p>
                          <p>
                            <b>Genres:</b> Adventure Comedy Fantasy Martial Arts Shounen
                            Super Power{" "}
                          </p>
                          <p><b>Studios:</b> Toei Animation </p>
                          <p><b>Producers:</b> Fuji TV, Toei Animation, Funimation</p>
                        </div>
                      </div>
                  </div>
                </div>
